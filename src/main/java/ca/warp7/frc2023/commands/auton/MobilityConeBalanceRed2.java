...
public class MobilityConeBalanceRed2 extends SequentialCommandGroup {
    public MobilityConeBalanceRed2(
        ...
        // PathConstraints constraints = PathPlanner.getConstraintsFromPath("MobilityConeBalanceRed2");
        PathPlannerTrajectory examplePath = PathPlanner.loadPath("MobilityConeBalanceRed2", 4.5, 3);
